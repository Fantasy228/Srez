...
class Request extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['reject_msg', 'required', 'when' => function($model, $attribute) { // Необходимо указание причины отказа при выборе статуса "Отказано"
                return $model->statusID == 3;
            ...
            ['imageFileBefore', 'required', 'when' => function($model, $attribute) { // Загрузка изображения результата обязательна при выборе статуса "Принято"
